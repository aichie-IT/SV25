...
page, sidebar_tab = sidebar_navigation()
...
# If user used sidebar to pick a subtab -> show only that tab's contents
if page == "🏍️ Motor Accident Severity Analysis" and sidebar_tab:
    # find index of chosen subtab and render only that block
    idx = tab_names.index(sidebar_tab)
    # render chosen tab content manually by indexing tabs[idx]
    with tabs[idx]:
        # set a session_state marker (optional) so other code can know
        st.session_state["_active_tab_"] = sidebar_tab
        
        if sidebar_tab == "⚙️ General Overview":
            ...
            """)
        elif sidebar_tab == "📊 Accident Factors":
            ...
            """)
        elif sidebar_tab == "📈 Numerical Analysis":
            ...
            **Interpretation:** Moderate daily travel distances (10–30 km) dominate the dataset, while excessive distance relates to fatigue and higher risk.
            ...
            """)
        elif sidebar_tab == "📉 Advanced Visualizations":
